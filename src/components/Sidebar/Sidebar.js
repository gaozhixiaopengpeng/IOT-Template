...
// utils
import { menuHasPermission } from "utils/permission";
...
class Sidebar extends React.Component {
  ...
  createLinks = (routes) => {
    ...
    return routes.map((prop, key) => {
      ...
      //permission this code handle permission display https://demos.creative-tim.com/material-dashboard-react/#/documentation/routing-system
      /* if (prop.invisible) {
        return null;
      } */
      //console.log(prop);
      
      // if (!menuHasPermission(prop.permission)) {
      //   return null;
      // }
      if (prop.collapse) {
        var st = {};
          ...
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                ...
                primary={store.getState().username}
                secondary={
                  <b
                    className={
                      caret +
